...
--
-- Client: localhost
-- Généré le: Lun 20 Janvier 2014 à 13:16
...
CREATE TABLE IF NOT EXISTS `etape` (
  ...
  `ResumeCourt` varchar(200) NOT NULL,
  `choix1` int(5) NOT NULL,
  `choix2` int(5) NOT NULL,
  PRIMARY KEY (`Id_E`)
...
INSERT INTO `etape` (`Id_E`, `Titre`, `Date`, `Video`, `Resume`, `Description`, `ResumeCourt`, `choix1`, `choix2`) VALUES
(1, 'N°1', '2014-01-20', 'video/etape1/video1.avi', 'Premiere étape du projetV', 'Voici la premiere étape du projet incognito réalisé par des étudiants de M1 PSM ', '', 2, 0),
(2, 'N°2', '2014-02-08', 'videos/etapes2/video.avi', '2eme étape', 'Voicie la 2eme etape du projet icognito ', '', 0, 0),
(3, 'N°3', '2014-02-22', 'videos/etape3.avi', 'blabla', 'bla bla bla bla bla bla', '', 0, 0),
(4, 'N°4', '2014-03-02', 'videos/etape4.avi', 'totoototo', 'tototototot', '', 0, 0),
(5, 'N°5', '2014-03-08', 'http://youtube.com ', 'Etape N° 5', '5e étape du projet', 'Etape 5', 6, 3);
...
(47, 'Photo', 'AZERTY', '', 'img/indice/etape1/40.png', '2014-01-24', '', 47.5098, 6.80516, 1),
(48, 'Plan', 'truc', 'naenmla aekf,maek,f evknaemk aevlkaenv', 'img/indice/etape1/48.svg+xml', '2014-01-31', 'http://google.com', 47.5059, 6.79648, 1);
...
--
-- Contenu de la table `vote_etape`
--

INSERT INTO `vote_etape` (`Id_V`, `Id_E`, `Ip`) VALUES
(1, 5, '127.0.0.1');
